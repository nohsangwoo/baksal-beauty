...
export const dictionaries: Record<Locale, HomeDictionary> = {
  ko: {
    ...
    common: {
      ...
      phoneCta: "제작 문의",
      consultCta: "제작 문의하기",
      servicesCta: "데모 구성 보기",
      viewDetails: "자세히 보기",
      readMore: "더 읽기",
      profileCta: "프로필 보기",
      guidedAfterConsultation: "요구사항 확인 후 안내",
      inquire: "문의하기",
    },
    hero: {
      announcement: "병원 홈페이지 제작 데모 페이지입니다 - 주식회사 럿지가 만든 BAKSAL BEAUTY 쇼케이스입니다.",
    ...
    inquiry: {
      eyebrow: "Website Production Inquiry",
      titleA: "병원 홈페이지 제작을",
      titleB: "럿지와 먼저 상담하세요.",
      body: "간단한 요구사항만 남기면 주식회사 럿지가 홈페이지 범위, 관리자 기능, SEO 콘텐츠 구조와 다음 단계를 정리해 안내합니다.",
      primaryCta: "제작 문의하기",
      secondaryCta: "구성 보기",
    ...
    consultation: {
      ...
      title: "홈페이지 제작 문의",
      body: "병원·성형외과 홈페이지 제작, 리뉴얼, 관리자 CMS, 블로그 SEO, 문의 전환 구조를 주식회사 럿지와 상담해보세요.",
      imageAlt: "홈페이지 제작 문의 섹션 이미지",
      fields: {
        name: "이름 *",
        phone: "연락처 *",
        email: "이메일 *",
      ...
      placeholders: {
        ...
        service: "제작 범위 선택",
        channel: "연락 방식",
        message: "제작하려는 홈페이지, 필요한 기능, 일정 등을 남겨주세요.",
      },
      services: ["병원 홈페이지 제작", "성형외과 홈페이지 제작", "홈페이지 리뉴얼", "관리자 CMS 구축", "블로그 SEO 구축", "문의/예약 전환 구조"],
      channels: ["이메일", "전화"],
      submit: "홈페이지 제작 문의 보내기",
    },
    shop: {
      eyebrow: "Our Shop",
      titleA: "Professional",
  ...
  en: {
    ...
    common: {
      ...
      phoneCta: "Project inquiry",
      consultCta: "Start project inquiry",
      servicesCta: "View demo structure",
      viewDetails: "View details",
      readMore: "Read more",
      profileCta: "Open profile",
      guidedAfterConsultation: "After scope review",
      inquire: "Inquire",
    },
    hero: {
      announcement: "Hospital website production demo - a BAKSAL BEAUTY showcase by LUDGI Inc.",
      eyebrow: "Advanced Aesthetic Medicine",
      titleTop: "BAKSAL",
      titleBottom: "BEAUTY",
      line: "Refined beauty, thoughtfully designed.",
    ...
    inquiry: {
      eyebrow: "Website Production Inquiry",
      titleA: "Plan your clinic website",
      titleB: "with LUDGI first.",
      body: "Leave a few requirements and LUDGI will outline the website scope, admin CMS, SEO content structure, and next steps.",
      primaryCta: "Start project inquiry",
      secondaryCta: "View structure",
    ...
    consultation: {
      eyebrow: "Direct Consultation",
      title: "Website production inquiry",
      body: "Ask LUDGI about hospital and plastic surgery clinic websites, renewals, admin CMS, blog SEO, and inquiry conversion flows.",
      imageAlt: "Website production inquiry section image",
      fields: {
        name: "Your name *",
        phone: "Your phone *",
        email: "Email *",
      ...
      placeholders: {
        ...
        phone: "010-0000-0000",
        email: "reply@example.com",
        service: "Select project scope",
        channel: "Contact method",
        message: "Tell us about the website, features, timeline, and goals you have in mind.",
      },
      services: ["Hospital website build", "Plastic surgery website build", "Website renewal", "Admin CMS", "Blog SEO system", "Inquiry conversion flow"],
      channels: ["Email", "Phone"],
      submit: "Send website inquiry",
    },
    shop: {
      eyebrow: "Our Shop",
      titleA: "Professional",
  ...
  zh: {
    ...
    common: {
      ...
      readMore: "阅读更多",
      profileCta: "查看简介",
      guidedAfterConsultation: "确认需求后说明",
      inquire: "咨询",
    },
    hero: {
      announcement: "医院官网制作演示页面 - 由 LUDGI Inc. 制作的 BAKSAL BEAUTY 展示案例。",
      eyebrow: "Advanced Aesthetic Medicine",
      titleTop: "BAKSAL",
      titleBottom: "BEAUTY",
      line: "Refined beauty, thoughtfully designed.",
    ...
    inquiry: {
      ...
      titleA: "医院官网制作",
      titleB: "先与 LUDGI 咨询。",
      body: "留下简单需求后，LUDGI 会整理网站范围、后台 CMS、SEO 内容结构和下一步流程。",
      primaryCta: "提交制作咨询",
      secondaryCta: "查看结构",
      imageAlt: "咨询申请横幅图片",
    },
    ...
    consultation: {
      eyebrow: "Direct Consultation",
      title: "网站制作咨询",
      body: "可咨询 LUDGI 关于医院与整形外科官网制作、改版、后台 CMS、博客 SEO 以及咨询转化流程。",
      imageAlt: "网站制作咨询区块图片",
      fields: {
        name: "姓名 *",
        phone: "联系电话 *",
      ...
      placeholders: {
        ...
        service: "选择项目范围",
        channel: "联系方式",
        message: "请填写想制作的网站、所需功能、预计时间和目标。",
      },
      services: ["医院官网制作", "整形外科官网制作", "网站改版", "后台 CMS", "博客 SEO 系统", "咨询转化流程"],
      channels: ["Email", "电话"],
      submit: "发送网站制作咨询",
    },
    shop: {
  ...
  ja: {
    ...
    common: {
      ...
      guidedAfterConsultation: "要件確認後に案内",
      inquire: "問い合わせ",
    },
    hero: {
      announcement: "病院ホームページ制作デモページ - LUDGI Inc. による BAKSAL BEAUTY ショーケースです。",
      eyebrow: "Advanced Aesthetic Medicine",
      titleTop: "BAKSAL",
      titleBottom: "BEAUTY",
      line: "Refined beauty, thoughtfully designed.",
    ...
    inquiry: {
      ...
      titleA: "病院サイト制作を",
      titleB: "まず LUDGI に相談。",
      body: "簡単な要件を残していただくと、LUDGI がサイト範囲、管理 CMS、SEO コンテンツ構造、次の手順を整理してご案内します。",
      primaryCta: "制作相談を送る",
      secondaryCta: "構成を見る",
    ...
    consultation: {
      eyebrow: "Direct Consultation",
      title: "ホームページ制作相談",
      body: "病院・美容外科サイト制作、リニューアル、管理 CMS、ブログ SEO、問い合わせ導線について LUDGI にご相談ください。",
      imageAlt: "ホームページ制作相談セクション画像",
      fields: {
        name: "お名前 *",
        phone: "連絡先 *",
        email: "メール *",
      ...
      placeholders: {
        ...
        service: "制作範囲を選択",
        channel: "連絡方法",
        message: "制作したいサイト、必要な機能、スケジュールなどを入力してください。",
      },
      services: ["病院サイト制作", "美容外科サイト制作", "サイトリニューアル", "管理 CMS", "ブログ SEO システム", "問い合わせ導線"],
      channels: ["Email", "電話"],
      submit: "制作相談を送信",
    },
    shop: {
